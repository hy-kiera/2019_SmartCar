...
# 116 "0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c"
    {
    ...
    (Ifx_Assert_doValidate(IfxGpt12_IncrEnc_init(&g_Gpt12Enc.incrEnc, &config), (2),"IfxGpt12_IncrEnc_init(&g_Gpt12Enc.incrEnc, &config)", "0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c", 138, __func__));
}
