...
# 17 "0_Src/AppSw/Tricore/SnsAct/BasicStm.c" 2
# 29 "0_Src/AppSw/Tricore/SnsAct/BasicStm.c"
typedef struct
{
    Ifx_STM *stmSfr;
...
# 59 "0_Src/AppSw/Tricore/SnsAct/BasicStm.c"
...
# 69 "0_Src/AppSw/Tricore/SnsAct/BasicStm.c"
...
volatile float userStatus = 0.0f;
void BasicStm_run(void)
{
 ...
 if(task_flag_100m == 1){
  ...
  userStatus+=0.25f;
  if((int)userStatus % 2 == 1) {

   IfxPort_setPinState(IfxPort_P00_0.port, IfxPort_P00_0.pinIndex, IfxPort_State_high);
  }
  else {

   IfxPort_setPinState(IfxPort_P00_0.port, IfxPort_P00_0.pinIndex, IfxPort_State_low);
  }
 }
