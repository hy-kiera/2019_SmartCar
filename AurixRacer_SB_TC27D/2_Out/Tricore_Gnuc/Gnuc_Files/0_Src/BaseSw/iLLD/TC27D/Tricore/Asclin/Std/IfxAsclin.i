...
boolean IfxAsclin_setBitTiming(Ifx_ASCLIN *asclin, float32 baudrate, IfxAsclin_OversamplingFactor oversampling, IfxAsclin_SamplePointPosition samplepoint, IfxAsclin_SamplesPerBit medianFilter)
{
    ...
    if (d >> 12)
    {
        if (((uint32)(fpd / (baudrate * 16))) >> 12)
        {
            ...
            (((0) || ((3) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((3),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Std/IfxAsclin.c", 267, __func__));
        }
        else
        {

            (((0) || ((3) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((3),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Std/IfxAsclin.c", 272, __func__));
        }
    }
