...
uint32 IfxQspi_calculateExtendedConfigurationValue(Ifx_QSPI *qspi, const uint8 cs, const SpiIf_ChConfig *chConfig)
{
    ...
    if (fBaud == 0.0)
    {
        (((0) || ((3) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((3),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Qspi/Std/IfxQspi.c", 91, __func__));
        fBaud = 1.0;
    }
...
uint32 IfxQspi_calculateTimeQuantumLength(Ifx_QSPI *qspi, float maxBaudrate)
{
    ...
    if (( !((maxBaudrate) > (0.0)) ))
    {
        (((0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Qspi/Std/IfxQspi.c", 187, __func__));
    }
