...
SpiIf_Status IfxQspi_SpiMaster_initChannel(IfxQspi_SpiMaster_Channel *chHandle, const IfxQspi_SpiMaster_ChannelConfig *chConfig)
{
...

    {
        ...
        {
            (((0) || ((3) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((3),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c", 259, __func__));
        }
...
void IfxQspi_SpiMaster_packLongModeBuffer(IfxQspi_SpiMaster_Channel *chHandle, void *data, uint32 *longFifoBuffer, Ifx_SizeT dataLength)
{
    ...
    {
        ((((0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"IFX_ASSERT_FEATURE_NOT_IMPLEMENTED", "0_Src/BaseSw/iLLD/TC27D/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c", 781, __func__));
    }
...
static void IfxQspi_SpiMaster_writeLong(IfxQspi_SpiMaster_Channel *chHandle)
{
    ...
    {
        ((((0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"IFX_ASSERT_FEATURE_NOT_IMPLEMENTED", "0_Src/BaseSw/iLLD/TC27D/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c", 1294, __func__));
    }
}
