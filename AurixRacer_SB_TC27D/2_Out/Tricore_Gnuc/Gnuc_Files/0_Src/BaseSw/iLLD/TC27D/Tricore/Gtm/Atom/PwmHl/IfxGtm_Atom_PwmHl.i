...
boolean IfxGtm_Atom_PwmHl_init(IfxGtm_Atom_PwmHl *driver, const IfxGtm_Atom_PwmHl_Config *config)
{
    ...
    (((config->base.channelCount <= (8)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.channelCount <= IFXGTM_ATOM_PWMHL_MAX_NUM_CHANNELS", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c", 173, __func__));
...
boolean IfxGtm_Atom_PwmHl_setMode(IfxGtm_Atom_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    ...
    if (base->mode != mode)
    {
        ...
        (((mode == IfxGtm_Atom_PwmHl_modes[mode].mode) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mode == IfxGtm_Atom_PwmHl_modes[mode].mode", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c", 284, __func__));
