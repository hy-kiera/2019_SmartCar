...
static void IfxDma_Dma_configureTransactionSet(Ifx_DMA_CH *channel, const IfxDma_Dma_ChannelConfig *config)
{
    ...
    {
        (((((config->shadowAddress & 0x1F) == 0U)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"((config->shadowAddress & 0x1F) == 0U)", "0_Src/BaseSw/iLLD/TC27D/Tricore/Dma/Dma/IfxDma_Dma.c", 50, __func__));
    }
