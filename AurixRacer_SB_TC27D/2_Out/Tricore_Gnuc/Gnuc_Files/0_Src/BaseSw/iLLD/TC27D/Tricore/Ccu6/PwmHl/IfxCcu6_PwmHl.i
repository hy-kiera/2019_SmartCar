...
boolean IfxCcu6_PwmHl_init(IfxCcu6_PwmHl *driver, const IfxCcu6_PwmHl_Config *config)
{
    ...
    (((config->base.channelCount == (3)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.channelCount == IFXCCU6_PWMHL_MAX_CHANNELS", "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.c", 203, __func__));
    (((config->timer->base.countDir == IfxStdIf_Timer_CountDir_upAndDown) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->timer->base.countDir == IfxStdIf_Timer_CountDir_upAndDown", "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.c", 204, __func__));
...
boolean IfxCcu6_PwmHl_setMode(IfxCcu6_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    ...
    if (base->mode != mode)
    {
        ...
        (((mode == IfxCcu6_PwmHl_modes[mode].mode) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mode == IfxCcu6_PwmHl_modes[mode].mode", "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.c", 322, __func__));
