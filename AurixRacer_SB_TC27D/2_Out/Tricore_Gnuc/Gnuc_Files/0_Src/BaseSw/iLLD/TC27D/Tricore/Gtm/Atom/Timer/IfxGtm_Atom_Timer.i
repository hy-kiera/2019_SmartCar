...
boolean IfxGtm_Atom_Timer_init(IfxGtm_Atom_Timer *driver, const IfxGtm_Atom_Timer_Config *config)
{
    ...
    (((config->base.countDir == IfxStdIf_Timer_CountDir_up) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.countDir == IfxStdIf_Timer_CountDir_up", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c", 147, __func__));
    ...
    if (base->triggerEnabled)
    {
        ...
        {
            result = 0;
            (((result) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"result", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c", 165, __func__));
        }
    }
    else
    {
    ...
    {
        result = 0;
        (((0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c", 189, __func__));
    }
    else
    {}
