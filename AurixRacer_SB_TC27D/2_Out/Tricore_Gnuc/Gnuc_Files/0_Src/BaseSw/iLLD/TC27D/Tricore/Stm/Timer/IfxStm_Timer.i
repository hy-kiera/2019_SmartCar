...
boolean IfxStm_Timer_init(IfxStm_Timer *driver, const IfxStm_Timer_Config *config)
{
    ...
    (((config->base.countDir == IfxStdIf_Timer_CountDir_up) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.countDir == IfxStdIf_Timer_CountDir_up", "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c", 171, __func__));
    ...
    (((config->base.trigger.enabled == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.trigger.enabled == FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c", 179, __func__));
    (((config->base.startOffset == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.startOffset == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c", 180, __func__));
    ...
    {
        result = 0;
        (((0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"FALSE", "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c", 198, __func__));
    }
    else
    {}
