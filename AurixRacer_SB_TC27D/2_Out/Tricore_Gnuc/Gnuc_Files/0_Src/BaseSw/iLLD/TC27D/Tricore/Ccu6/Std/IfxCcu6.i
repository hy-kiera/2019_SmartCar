...
void IfxCcu6_setT12InputSignal(Ifx_CCU6 *ccu6, IfxCcu6_T12hr_In *extInput)
{
    ...
    (((extInput->module == ccu6) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"extInput->module == ccu6", "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c", 418, __func__));
}
...
void IfxCcu6_setT13InputSignal(Ifx_CCU6 *ccu6, IfxCcu6_T13hr_In *extInput)
{
    ...
    (((extInput->module == ccu6) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"extInput->module == ccu6", "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c", 506, __func__));
}
