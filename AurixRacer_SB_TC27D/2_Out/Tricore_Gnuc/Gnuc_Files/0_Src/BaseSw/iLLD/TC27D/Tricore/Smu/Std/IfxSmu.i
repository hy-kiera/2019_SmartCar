...
static inline __attribute__ ((always_inline)) boolean IfxSmu_triggerAlarm(Ifx_SMU *smu, IfxSmu_Alarm alarm)
{
    ...
    ((((alarm >> 8) == IfxSmu_AlarmGroup_5) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(alarm >> 8) == IfxSmu_AlarmGroup_5", "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h", 290, __func__));
