...
boolean IfxGtm_Tom_PwmHl_init(IfxGtm_Tom_PwmHl *driver, const IfxGtm_Tom_PwmHl_Config *config)
{
    ...
    (((config->base.channelCount <= (3)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"config->base.channelCount <= IFXGTM_TOM_PWMHL_MAX_NUM_CHANNELS", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Tom/PwmHl/IfxGtm_Tom_PwmHl.c", 183, __func__));
...
boolean IfxGtm_Tom_PwmHl_setMode(IfxGtm_Tom_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    ...
    if (base->mode != mode)
    {
        ...
        (((mode == IfxGtm_Tom_PwmHl_modes[mode].mode) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mode == IfxGtm_Tom_PwmHl_modes[mode].mode", "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Tom/PwmHl/IfxGtm_Tom_PwmHl.c", 313, __func__));
