...
void IfxEth_init(IfxEth *eth, const IfxEth_Config *config)
{
    ...
    (((sizeof(IfxEth_TxDescr) == (4 * sizeof(uint32))) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"sizeof(IfxEth_TxDescr) == (IFXETH_DESCR_SIZE * sizeof(uint32))", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 223, __func__));
    (((sizeof(IfxEth_RxDescr) == (4 * sizeof(uint32))) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"sizeof(IfxEth_RxDescr) == (IFXETH_DESCR_SIZE * sizeof(uint32))", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 224, __func__));
...
void IfxEth_initReceiveDescriptorsRingMode(IfxEth *eth, const IfxEth_RingModeRxBuffersConfig *config)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        {
            ((((config->rxBuffer1Size) % 4 == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(config->rxBuffer1Size) % 4 == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 352, __func__));
        ...
        {
            ((((config->rxBuffer2Size) % 4 == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(config->rxBuffer2Size) % 4 == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 363, __func__));
...
void IfxEth_initTransmitDescriptorsRingMode(IfxEth *eth, const IfxEth_RingModeTxBuffersConfig *config)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        {
            ((((config->txBuffer1Size) % 4 == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(config->txBuffer1Size) % 4 == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 458, __func__));
        ...
        {
            ((((config->txBuffer2Size) % 4 == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(config->txBuffer2Size) % 4 == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Eth/Std/IfxEth.c", 470, __func__));
