...
void IfxMtu_clearSram(IfxMtu_MbistSel mbistSel)
{
    ...
    ((((((Ifx_MC *)((0xF0061000u) + 0x100 * mbistSel))->MSTATUS.B.DONE != 0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(((Ifx_MC *)(IFXMTU_MC_ADDRESS_BASE + 0x100 * mbistSel))->MSTATUS.B.DONE != 0)", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 83, __func__));
...
void IfxMtu_clearSramStart(IfxMtu_MbistSel mbistSel)
{
    ...
    {
        (((mbistSel < (84)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mbistSel < IFXMTU_NUM_MBIST_TABLE_ITEMS", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 129, __func__));
        const IfxMtu_SramItem *item = (IfxMtu_SramItem *)&IfxMtu_sramTable[mbistSel];

        uint8 numBlocks = item->numBlocks;
        (((numBlocks > 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"numBlocks > 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 133, __func__));
...
uint8 IfxMtu_runCheckerBoardTest(IfxMtu_MbistSel mbistSel, uint8 rangeSel, uint8 rangeAddrUp, uint8 rangeAddrLow, uint16 *errorAddr, uint32 numberRedundancyLines)
{
    ...
    for (testStep = 0; testStep < 4; ++testStep)
    {
        ...
        (((mc->MSTATUS.B.DONE != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mc->MSTATUS.B.DONE != 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 347, __func__));
...
uint8 IfxMtu_runMarchUTest(IfxMtu_MbistSel mbistSel, uint8 rangeSel, uint8 rangeAddrUp, uint8 rangeAddrLow, uint16 *errorAddr)
{
    ...
    for (testStep = 0; testStep < 6; ++testStep)
    {
        ...
        IfxMtu_waitForMbistDone(IfxMtu_sramTable[mbistSel].mbistDelay, 4, mbistSel);
        (((mc->MSTATUS.B.DONE != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mc->MSTATUS.B.DONE != 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 439, __func__));
...
uint8 IfxMtu_runNonDestructiveInversionTest(IfxMtu_MbistSel mbistSel, uint8 rangeSel, uint8 rangeAddrUp, uint8 rangeAddrLow, uint16 *errorAddr)
{
    ...
    IfxMtu_waitForMbistDone(IfxMtu_sramTable[mbistSel].mbistDelay, 4, mbistSel);
    (((mc->MSTATUS.B.DONE != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mc->MSTATUS.B.DONE != 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 520, __func__));
...
void IfxMtu_writeSramAddress(IfxMtu_MbistSel mbistSel, uint16 sramAddress)
{
    ...
    IfxMtu_waitForMbistDone(IfxMtu_sramTable[mbistSel].mbistDelay, 1, mbistSel);
    (((mc->MSTATUS.B.DONE != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"mc->MSTATUS.B.DONE != 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Mtu/Std/IfxMtu.c", 673, __func__));
