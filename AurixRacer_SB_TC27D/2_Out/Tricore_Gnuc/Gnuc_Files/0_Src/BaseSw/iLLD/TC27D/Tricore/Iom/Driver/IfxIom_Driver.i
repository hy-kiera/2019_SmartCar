...
boolean IfxIom_Driver_initLam(IfxIom_Driver_Lam *driver, IfxIom_Driver_LamConfig *config)
{
    ...
    ((((config->systemEventTriggerThreshold & (~(0xfu))) == 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"(config->systemEventTriggerThreshold & (~IFX_IOM_ECMCCFG_THRC0_MSK)) == 0", "0_Src/BaseSw/iLLD/TC27D/Tricore/Iom/Driver/IfxIom_Driver.c", 175, __func__));
