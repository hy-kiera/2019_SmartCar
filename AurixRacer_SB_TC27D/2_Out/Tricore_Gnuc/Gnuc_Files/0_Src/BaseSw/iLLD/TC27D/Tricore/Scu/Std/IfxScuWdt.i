...
boolean IfxScuWdt_enableWatchdogWithDebugger(void)
{
    ...
    (((oenEnabled == 1) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"oenEnabled == 1", "0_Src/BaseSw/iLLD/TC27D/Tricore/Scu/Std/IfxScuWdt.c", 450, __func__));
    ...
    (((watchdogEnabled == 1) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"watchdogEnabled == 1", "0_Src/BaseSw/iLLD/TC27D/Tricore/Scu/Std/IfxScuWdt.c", 461, __func__));
