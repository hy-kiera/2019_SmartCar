...
.LVL19:
	.loc 1 173 0
	movh.a	%a2, hi:IfxPort_P11_11
	lea	%a15, [%a2] lo:IfxPort_P11_11
	ld.a	%a4, [%a2] lo:IfxPort_P11_11
	ld.bu	%d4, [%a15] 4
	mov	%d5, 128
	call	IfxPort_setPinMode
.LVL20:
...
.LVL27:
	...
	add	%d2, 1
	st.w	[%a15] lo:vadcCount, %d2
	.loc 1 210 0
	ld.w	%d2, [%a15] lo:vadcCount
	lt	%d2, %d2, 10
	jnz	%d2, .L20
	.loc 1 211 0
	movh.a	%a2, hi:sstatus
	ld.w	%d2, [%a2] lo:sstatus
	lt	%d2, %d2, 20
	jz	%d2, .L33
	.loc 1 216 0
	ld.w	%d2, [%a2] lo:sstatus
	...
	.loc 1 216 0
	add	%d2, 1
	st.w	[%a2] lo:sstatus, %d2
	.loc 1 217 0
	ld.w	%d2, [%a12] lo:status
	jz	%d2, .L34
	.loc 1 221 0
	ld.w	%d15, [%a12] lo:status
	jeq	%d15, 1, .L35
.L23:
	.loc 1 226 0
	mov	%d15, 0
	st.w	[%a15] lo:vadcCount, %d15
.L20:
	.loc 1 229 0
	movh.a	%a15, hi:ledState
	ld.w	%d15, [%a15] lo:ledState
	jeq	%d15, 1, .L36
.L26:
	.loc 1 231 0
	ld.w	%d15, [%a15] lo:ledState
...
.L27:
	...
	ld.w	%d15, [%a15] lo:ledState
	rsub	%d15
	st.w	[%a15] lo:ledState, %d15
	j	.L19
.L33:
	.loc 1 212 0
	movh.a	%a2, hi:IR_Srv
	movh	%d4, 16026
	ld.w	%d15, [%a2] lo:IR_Srv
	addi	%d4, %d4, -26214
	cmp.f	%d15, %d15, %d4
	and	%d15, %d15, 13
	jz	%d15, .L23
...
status:
	.zero	4
	.global	ledState
.section .data.ledState,"aw",@progbits
	.align 2
...
.Letext0:
	...
	.file 16 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.h"
	.file 17 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxPort_PinMap.h"
	.file 18 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Assert.h"
	.file 19 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h"
	.file 20 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Main/Release/AppTaskFu.h"
	.file 21 "<built-in>"
...
.LASF8:
	...
	.extern	IfxPort_P11_11,STT_OBJECT,8
