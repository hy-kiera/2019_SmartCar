...
.LBE84:
	...
	ld.w	%d2, [%a12] 12
	mul.u	%e4, %d4, 5
	addi	%d11, %d11, lo:g_VadcAutoScan
	movh	%d10, hi:IR_LineScan
	madd	%d5, %d5, %d2, 5
	movh	%d12, hi:getLine
	.loc 1 169 0
	mov	%d8, 0
